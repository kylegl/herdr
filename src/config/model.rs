...
pub struct KeysConfig {
    ...
    /// Dismiss the current attention dock item. Default: "prefix+shift+o".
    pub dismiss_attention: BindingConfig,
...
pub(crate) struct KeysConfigOverlay {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    dismiss_attention: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KeysConfig {
    ...
    pub(crate) fn local_profile(&self, keybinds: &Keybinds) -> KeysConfigOverlay {
        ...
        copy_effective_action_field!(dismiss_attention, keybinds.dismiss_attention);
...
impl Default for KeysConfig {
    fn default() -> Self {
        Self {
            ...
            dismiss_attention: BindingConfig::one("prefix+shift+o"),
