    ...
    fn compose_unavailable(&mut self, cols: u16, rows: u16) -> FrameData {
        ...
        super::endpoint_sidebar::render_expanded(
            ...
            &mut render::ShellRenderState {
                ...
                selected_endpoint_id: self
                    .navigate_endpoint_id
                    .as_ref()
                    .or(Some(&self.active_endpoint_id)),
    ...
    pub(crate) fn compose(&mut self, cols: u16, rows: u16) -> Option<FrameData> {
        ...
        self.hits = render::render_shell(
            ...
            render::ShellRenderState {
                ...
                selected_endpoint_id: (self.mode == ClientShellMode::Navigate).then_some(
                ...
                selected_workspace_id: (self.mode == ClientShellMode::Navigate)
                    ...
                    .flatten(),
                selected_agent_pane_id: (self.mode == ClientShellMode::Navigate)
