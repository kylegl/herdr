...
The sidebar's Attention counts open an interactive overlay for blocked agents and unseen completions without rearranging your panes. New arrivals never open it automatically. See [Agents](/docs/agents/#attention-queue).
